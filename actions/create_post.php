...
if (isset($_SESSION["user_id"])):
    ...
    $category       = (isset($_POST["post_category"])) ? $_POST["post_category"] : false;
            ...
            if (
                ...
                if (!file_exists($file_name)
                    ...
                    if (move_uploaded_file($_FILES["post_image"]["tmp_name"], ($file_name))) {
                        $insert_image_query = "INSERT INTO post_images (url, owner_id, date_uploaded) VALUES ('".str_replace($_SERVER["DOCUMENT_ROOT"], "", $file_name)."', $user_id, '$date_created')";
